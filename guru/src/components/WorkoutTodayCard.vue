...
<template>
    <div class="card mb-3">
        <div class="card-body">
            <h5 class="card-title">ออกกำลังกายวันนี้</h5>
            ...
            <div class="row g-2">
                ...
                <div class="col-6">
                    <button @click="setStatus('partial')" class="btn w-100 py-2 small"
                        :class="status === 'partial' ? 'text-warning border border-warning' : 'text-muted bg-transparent border border-secondary'">
                        ทำบางส่วน
                    </button>
                </div>
                <div class="col-6">
                    <button @click="setStatus('skip')" class="btn w-100 py-2 small"
                        :class="status === 'skip' ? 'text-danger border border-danger' : 'text-muted bg-transparent border border-secondary'">
                        ข้าม
                    </button>
                </div>
            </div>
